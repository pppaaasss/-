...
for iptv_name in home_probe.py peak_policy.py home_resources.py home_transport.py home_contract.py home_decision.py pipeline_trial.py pipeline_auto.py runtime_audit.sh; do
