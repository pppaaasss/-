...
def main() -> int:
    ...
    # tv-core.m3u is generated by the IPv6 reinforcement pass immediately
    # before this rescue. Keep the dedicated core subscription on the same
    # final CCTV-5 rescue set instead of leaving it with the pre-rescue tile.
    rewrite_playlist(Path("tv-core.m3u"), selected, MAIN_BACKUP_COUNT)
